...
# Packaging @sebastienrousseau/commitlint-config
...
Peer dependency: `@commitlint/cli >=18.0.0`.
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/commitlint-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/commitlint-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/commitlint-config/` |
| Homebrew | [`pkg/brew/commitlint-config.rb`](../pkg/brew/commitlint-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/commitlint-config/` |
