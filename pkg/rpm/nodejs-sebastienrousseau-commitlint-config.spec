...
%global npm_bare      commitlint-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-commitlint-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Conventional Commits commitlint configuration rules

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/commitlint-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/commitlint-config is a shareable configuration preset with no runtime
