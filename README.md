...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/commitlint-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fcommitlint-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/commitlint-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14507"><img src="https://img.shields.io/cii/level/14507?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Conventional Commits Enforcement](#conventional-commits-enforcement) — before and after rule comparison
...
Install `@sebastienrousseau/commitlint-config` as a development dependency:
...
commitlint reads `commitlint.config.js` from the repository root.
...
`@sebastienrousseau/commitlint-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/commitlint-config` solves this with three deliberate engineering choices:
...
When your team mandates an alternative commit message convention (such as Gitmoji or ticket-prefixed Jira formatting) instead of Conventional Commits.
