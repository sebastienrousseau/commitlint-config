...
This document describes how @sebastienrousseau/commitlint-config is run: who decides what, how
...
@sebastienrousseau/commitlint-config is **maintainer-led**. As of the current release line it has a single
